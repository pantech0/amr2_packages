...
#ifndef ROBOI_AMR_MSGS__MSG__DETAIL__STSTATUS__STRUCT_HPP_
#define ROBOI_AMR_MSGS__MSG__DETAIL__STSTATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__roboi_amr_msgs__msg__Ststatus __attribute__((deprecated))
#else
# define DEPRECATED__roboi_amr_msgs__msg__Ststatus __declspec(deprecated)
#endif
...
struct Ststatus_
{
  using Type = Ststatus_<ContainerAllocator>;

  explicit Ststatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Ststatus_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  // pointer types
  using RawPtr =
    roboi_amr_msgs::msg::Ststatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const roboi_amr_msgs::msg::Ststatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<roboi_amr_msgs::msg::Ststatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<roboi_amr_msgs::msg::Ststatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      roboi_amr_msgs::msg::Ststatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<roboi_amr_msgs::msg::Ststatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<roboi_amr_msgs::msg::Ststatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<roboi_amr_msgs::msg::Ststatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<roboi_amr_msgs::msg::Ststatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__roboi_amr_msgs__msg__Ststatus
    std::shared_ptr<roboi_amr_msgs::msg::Ststatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__roboi_amr_msgs__msg__Ststatus
    std::shared_ptr<roboi_amr_msgs::msg::Ststatus_<ContainerAllocator> const>
  ...
  bool operator==(const Ststatus_ & other) const
  {
...
using Ststatus =
  roboi_amr_msgs::msg::Ststatus_<std::allocator<void>>;
...
#endif  // ROBOI_AMR_MSGS__MSG__DETAIL__STSTATUS__STRUCT_HPP_
