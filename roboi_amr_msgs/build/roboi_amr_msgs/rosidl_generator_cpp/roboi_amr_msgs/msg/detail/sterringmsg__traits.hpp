...
#ifndef ROBOI_AMR_MSGS__MSG__DETAIL__STERRINGMSG__TRAITS_HPP_
#define ROBOI_AMR_MSGS__MSG__DETAIL__STERRINGMSG__TRAITS_HPP_
...
inline std::string to_yaml(const Sterringmsg & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const roboi_amr_msgs::msg::Sterringmsg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const roboi_amr_msgs::msg::Sterringmsg & msg)
{
  return roboi_amr_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<roboi_amr_msgs::msg::Sterringmsg>()
{
  return "roboi_amr_msgs::msg::Sterringmsg";
}

template<>
inline const char * name<roboi_amr_msgs::msg::Sterringmsg>()
{
  return "roboi_amr_msgs/msg/Sterringmsg";
}

template<>
struct has_fixed_size<roboi_amr_msgs::msg::Sterringmsg>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<roboi_amr_msgs::msg::Sterringmsg>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<roboi_amr_msgs::msg::Sterringmsg>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROBOI_AMR_MSGS__MSG__DETAIL__STERRINGMSG__TRAITS_HPP_
