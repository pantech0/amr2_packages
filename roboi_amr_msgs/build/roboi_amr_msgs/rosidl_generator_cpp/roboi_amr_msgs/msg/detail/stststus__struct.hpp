...
#ifndef ROBOI_AMR_MSGS__MSG__DETAIL__STSTSTUS__STRUCT_HPP_
#define ROBOI_AMR_MSGS__MSG__DETAIL__STSTSTUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__roboi_amr_msgs__msg__Stststus __attribute__((deprecated))
#else
# define DEPRECATED__roboi_amr_msgs__msg__Stststus __declspec(deprecated)
#endif
...
struct Stststus_
{
  using Type = Stststus_<ContainerAllocator>;

  explicit Stststus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
  ...
  explicit Stststus_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
  ...
  using ConstRawPtr =
    const roboi_amr_msgs::msg::Stststus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<roboi_amr_msgs::msg::Stststus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<roboi_amr_msgs::msg::Stststus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      roboi_amr_msgs::msg::Stststus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<roboi_amr_msgs::msg::Stststus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<roboi_amr_msgs::msg::Stststus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<roboi_amr_msgs::msg::Stststus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<roboi_amr_msgs::msg::Stststus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__roboi_amr_msgs__msg__Stststus
    std::shared_ptr<roboi_amr_msgs::msg::Stststus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__roboi_amr_msgs__msg__Stststus
    std::shared_ptr<roboi_amr_msgs::msg::Stststus_<ContainerAllocator> const>
  ...
  bool operator==(const Stststus_ & other) const
  {
...
using Stststus =
  roboi_amr_msgs::msg::Stststus_<std::allocator<void>>;
...
#endif  // ROBOI_AMR_MSGS__MSG__DETAIL__STSTSTUS__STRUCT_HPP_
