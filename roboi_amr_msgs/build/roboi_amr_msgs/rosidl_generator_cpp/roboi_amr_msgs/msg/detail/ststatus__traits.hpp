...
#ifndef ROBOI_AMR_MSGS__MSG__DETAIL__STSTATUS__TRAITS_HPP_
#define ROBOI_AMR_MSGS__MSG__DETAIL__STSTATUS__TRAITS_HPP_
...
inline std::string to_yaml(const Ststatus & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const roboi_amr_msgs::msg::Ststatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const roboi_amr_msgs::msg::Ststatus & msg)
{
  return roboi_amr_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<roboi_amr_msgs::msg::Ststatus>()
{
  return "roboi_amr_msgs::msg::Ststatus";
}

template<>
inline const char * name<roboi_amr_msgs::msg::Ststatus>()
{
  return "roboi_amr_msgs/msg/Ststatus";
}

template<>
struct has_fixed_size<roboi_amr_msgs::msg::Ststatus>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<roboi_amr_msgs::msg::Ststatus>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<roboi_amr_msgs::msg::Ststatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROBOI_AMR_MSGS__MSG__DETAIL__STSTATUS__TRAITS_HPP_
