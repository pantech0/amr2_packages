...
#include "roboi_amr_msgs/msg/detail/sterringmsg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const roboi_amr_msgs::msg::Sterringmsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roboi_amr_msgs::msg::Sterringmsg & ros_message)
{
  // Member: isberrorall
  {
    uint8_t tmp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_roboi_amr_msgs
max_serialized_size_Sterringmsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roboi_amr_msgs::msg::Sterringmsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roboi_amr_msgs::msg::Sterringmsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roboi_amr_msgs::msg::Sterringmsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Sterringmsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const roboi_amr_msgs::msg::Sterringmsg *>(
...
static size_t _Sterringmsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Sterringmsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Sterringmsg__callbacks = {
  "roboi_amr_msgs::msg",
  "Sterringmsg",
...
static rosidl_message_type_support_t _Sterringmsg__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Sterringmsg__callbacks,
...
{
  return &roboi_amr_msgs::msg::typesupport_fastrtps_cpp::_Sterringmsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roboi_amr_msgs, msg, Sterringmsg)() {
  return &roboi_amr_msgs::msg::typesupport_fastrtps_cpp::_Sterringmsg__handle;
}
