...
#include "roboi_amr_msgs/msg/detail/ststatus__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roboi_amr_msgs::msg::Ststatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roboi_amr_msgs::msg::Ststatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roboi_amr_msgs::msg::Ststatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Ststatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const roboi_amr_msgs::msg::Ststatus *>(
...
static size_t _Ststatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Ststatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Ststatus__callbacks = {
  "roboi_amr_msgs::msg",
  "Ststatus",
...
static rosidl_message_type_support_t _Ststatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Ststatus__callbacks,
...
{
  return &roboi_amr_msgs::msg::typesupport_fastrtps_cpp::_Ststatus__handle;
}
