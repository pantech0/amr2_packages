...
static const _Ledcommand_type_support_symbol_names_t _Ledcommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roboi_amr_msgs, msg, Ledcommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roboi_amr_msgs, msg, Ledcommand)),
  }
};
...
{
  return &::roboi_amr_msgs::msg::rosidl_typesupport_cpp::Ledcommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, roboi_amr_msgs, msg, Ledcommand)() {
  return get_message_type_support_handle<roboi_amr_msgs::msg::Ledcommand>();
}
