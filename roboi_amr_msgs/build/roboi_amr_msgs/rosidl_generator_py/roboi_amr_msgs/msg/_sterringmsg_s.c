...
bool roboi_amr_msgs__msg__sterringmsg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("roboi_amr_msgs.msg._sterringmsg.Sterringmsg", full_classname_dest, 43) == 0);
  }
  roboi_amr_msgs__msg__Sterringmsg * ros_message = _ros_message;
  {  // isberrorall
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * roboi_amr_msgs__msg__sterringmsg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Sterringmsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("roboi_amr_msgs.msg._sterringmsg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Sterringmsg");
  ...
  roboi_amr_msgs__msg__Sterringmsg * ros_message = (roboi_amr_msgs__msg__Sterringmsg *)raw_ros_message;
  {  // isberrorall
    PyObject * field = NULL;
