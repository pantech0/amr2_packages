...
bool roboi_amr_msgs__msg__stststus__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("roboi_amr_msgs.msg._stststus.Stststus", full_classname_dest, 37) == 0);
  }
  roboi_amr_msgs__msg__Stststus * ros_message = _ros_message;
  {  // isberrorall
...
{
  /* NOTE(esteve): Call constructor of Stststus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("roboi_amr_msgs.msg._stststus");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Stststus");
  ...
  roboi_amr_msgs__msg__Stststus * ros_message = (roboi_amr_msgs__msg__Stststus *)raw_ros_message;
  {  // isberrorall
    PyObject * field = NULL;
