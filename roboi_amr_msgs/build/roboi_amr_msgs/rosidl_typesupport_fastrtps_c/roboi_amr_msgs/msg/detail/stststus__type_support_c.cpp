...
#include "roboi_amr_msgs/msg/detail/stststus__rosidl_typesupport_fastrtps_c.h"
...
using _Stststus__ros_msg_type = roboi_amr_msgs__msg__Stststus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Stststus__ros_msg_type * ros_message = static_cast<const _Stststus__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _Stststus__ros_msg_type * ros_message = static_cast<_Stststus__ros_msg_type *>(untyped_ros_message);
  // Field name: isberrorall
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _Stststus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roboi_amr_msgs__msg__Stststus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roboi_amr_msgs__msg__Stststus;
    is_plain =
      (
...
static size_t _Stststus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roboi_amr_msgs__msg__Stststus(
...
static message_type_support_callbacks_t __callbacks_Stststus = {
  "roboi_amr_msgs::msg",
  "Stststus",
...
static rosidl_message_type_support_t _Stststus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Stststus,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboi_amr_msgs, msg, Stststus)() {
  return &_Stststus__type_support;
}
