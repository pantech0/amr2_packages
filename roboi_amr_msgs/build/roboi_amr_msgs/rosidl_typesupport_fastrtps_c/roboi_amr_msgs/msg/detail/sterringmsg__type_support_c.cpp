...
#include "roboi_amr_msgs/msg/detail/sterringmsg__rosidl_typesupport_fastrtps_c.h"
...
using _Sterringmsg__ros_msg_type = roboi_amr_msgs__msg__Sterringmsg;

static bool _Sterringmsg__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Sterringmsg__ros_msg_type * ros_message = static_cast<const _Sterringmsg__ros_msg_type *>(untyped_ros_message);
...
static bool _Sterringmsg__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _Sterringmsg__ros_msg_type * ros_message = static_cast<_Sterringmsg__ros_msg_type *>(untyped_ros_message);
  // Field name: isberrorall
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_roboi_amr_msgs__msg__Sterringmsg(
  const void * untyped_ros_message,
...
static uint32_t _Sterringmsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roboi_amr_msgs__msg__Sterringmsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roboi_amr_msgs
size_t max_serialized_size_roboi_amr_msgs__msg__Sterringmsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roboi_amr_msgs__msg__Sterringmsg;
    is_plain =
      (
...
static size_t _Sterringmsg__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_roboi_amr_msgs__msg__Sterringmsg(
...
static message_type_support_callbacks_t __callbacks_Sterringmsg = {
  "roboi_amr_msgs::msg",
  "Sterringmsg",
  _Sterringmsg__cdr_serialize,
  _Sterringmsg__cdr_deserialize,
  _Sterringmsg__get_serialized_size,
  _Sterringmsg__max_serialized_size
};

static rosidl_message_type_support_t _Sterringmsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Sterringmsg,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboi_amr_msgs, msg, Sterringmsg)() {
  return &_Sterringmsg__type_support;
}
