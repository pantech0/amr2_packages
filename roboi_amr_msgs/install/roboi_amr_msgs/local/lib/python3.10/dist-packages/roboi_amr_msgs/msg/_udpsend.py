...
class Udpsend(metaclass=Metaclass_Udpsend):
    ...
    def __init__(self, **kwargs):
        ...
        self.isindicator = kwargs.get('isindicator', int())
        from roboi_amr_msgs.msg import Stststus
    ...
    def __eq__(self, other):
        ...
        if self.count != other.count:
            return False
        if self.isindicator != other.isindicator:
            return False
    ...
    def isindicator(self):
        """Message field 'isindicator'."""
        return self._isindicator

    @isindicator.setter
    def isindicator(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'isindicator' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'isindicator' field must be an unsigned integer in [0, 255]"
        self._isindicator = value
