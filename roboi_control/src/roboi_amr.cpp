...
: Node("roboi_amr_node", node_options)
{
  ...
  roboi_driver_callback_group_ = create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
  roboi_joy_callback_group_ = create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive);
  ...
  roboi_driver_ = std::make_shared<roboi_driver>(this, roboi_driver_callback_group_);
  roboi_joy_ = std::make_shared<roboi_joy>(this, roboi_joy_callback_group_);
