...
#include "roboi_amr_msgs/msg/detail/udpmsg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const roboi_amr_msgs::msg::AngleStatus &,
...
// functions for roboi_amr_msgs::msg::AngleStatus already declared above
...
cdr_serialize(
  const roboi_amr_msgs::msg::Udpmsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roboi_amr_msgs::msg::Udpmsg & ros_message)
{
  // Member: count
  cdr >> ros_message.count;
  ...
  size_t current_alignment)
{
  ...
  // Member: st_fl
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        roboi_amr_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_AngleStatus(
  ...
  if (is_plain) {
    ...
    using DataType = roboi_amr_msgs::msg::Udpmsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roboi_amr_msgs::msg::Udpmsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roboi_amr_msgs::msg::Udpmsg *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Udpmsg__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const roboi_amr_msgs::msg::Udpmsg *>(
...
static size_t _Udpmsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Udpmsg(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Udpmsg__callbacks = {
  "roboi_amr_msgs::msg",
  "Udpmsg",
...
static rosidl_message_type_support_t _Udpmsg__handle = {
...
{
  return &roboi_amr_msgs::msg::typesupport_fastrtps_cpp::_Udpmsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roboi_amr_msgs, msg, Udpmsg)() {
  return &roboi_amr_msgs::msg::typesupport_fastrtps_cpp::_Udpmsg__handle;
}
