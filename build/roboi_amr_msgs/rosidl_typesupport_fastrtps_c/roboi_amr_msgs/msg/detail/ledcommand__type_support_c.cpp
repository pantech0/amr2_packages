...
#include "roboi_amr_msgs/msg/detail/ledcommand__rosidl_typesupport_fastrtps_c.h"
...
using _Ledcommand__ros_msg_type = roboi_amr_msgs__msg__Ledcommand;
...
size_t get_serialized_size_roboi_amr_msgs__msg__Ledcommand(
  const void * untyped_ros_message,
...
static uint32_t _Ledcommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_roboi_amr_msgs__msg__Ledcommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_roboi_amr_msgs
size_t max_serialized_size_roboi_amr_msgs__msg__Ledcommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roboi_amr_msgs__msg__Ledcommand;
    is_plain =
      (
...
static size_t _Ledcommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_roboi_amr_msgs__msg__Ledcommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboi_amr_msgs, msg, Ledcommand)() {
