...
static const _Ledcommand_type_support_symbol_names_t _Ledcommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboi_amr_msgs, msg, Ledcommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboi_amr_msgs, msg, Ledcommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roboi_amr_msgs, msg, Ledcommand)() {
  return &::roboi_amr_msgs::msg::rosidl_typesupport_c::Ledcommand_message_type_support_handle;
}
